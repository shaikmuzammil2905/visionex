  ...
  return (
    <div className="pt-28 pb-20">
      <div className="container-custom max-w-6xl mx-auto space-y-8">
        <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-purple-500/30 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative overflow-hidden bg-gradient-to-r from-purple-950/40 via-slate-900 to-blue-950/40">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-2xl bg-purple-950 border border-purple-500/40 flex items-center justify-center text-purple-300 font-bold text-2xl overflow-hidden shadow-xl shrink-0">
              {user.avatar_url ? (
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase bg-purple-600 text-white shadow">
                  {user.role}
                </span>
              </div>
          ...
          <div className="flex items-center gap-2.5 self-stretch sm:self-auto">
            ...
            <button
              ...
              className="p-2 rounded-xl bg-white/5 border border-white/10 text-slate-400 hover:text-red-400 transition-colors"
              title="Logout"
            >
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="glass-card p-5 rounded-2xl border-purple-500/20">
                ...
                <div className="text-2xl font-extrabold text-white font-mono">Stage 02</div>
                <div className="text-xs text-slate-400 mt-1">Skill Building & Prototyping</div>
              </div>
              ...
              <div className="glass-card p-5 rounded-2xl border-blue-500/20">
                ...
                <div className="text-xs text-slate-400 mt-1">Next session in 8 days</div>
              </div>
              ...
              <div className="glass-card p-5 rounded-2xl border-emerald-500/20">
                ...
                <div className="text-2xl font-extrabold text-white font-mono">Creator Apprentice</div>
                <div className="text-xs text-slate-400 mt-1">Verified Member Status</div>
              </div>
            </div>
            ...
            <div className="glass-card p-6 rounded-2xl border border-white/10 space-y-4">
              ...
              <div className="space-y-2.5">
                {notifications.map((n) => (
                  <div
                    key={n.id}
                    className="p-3.5 rounded-xl bg-white/5 border border-white/5 flex items-start gap-3 text-xs"
                  >
        ...
        {activeTab === 'learning' && (
          <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-white/10 space-y-6">
            <div>
              <h3 className="text-lg font-bold text-white">Student Creator Milestones</h3>
        ...
        {activeTab === 'events' && (
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-white">Your Scheduled Workshops</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {events.map((evt: any) => (
                <div key={evt.id} className="glass-card p-5 rounded-2xl border border-white/10 flex flex-col justify-between">
        ...
        {activeTab === 'saved' && (
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-white">Your Bookmarked Resources</h3>
            {savedArticles.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {savedArticles.map((art: any) => (
                  <div key={art.id} className="glass-card p-5 rounded-2xl border border-white/10 flex flex-col justify-between">
                    <div>
        ...
        {activeTab === 'profile' && (
          <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-white/10 max-w-xl mx-auto space-y-6">
            ...
            <form onSubmit={handleProfileSave} className="space-y-4">
              <div className="space-y-1">
                <label className="text-xs font-mono font-bold text-slate-300 uppercase">Bio / Creator Statement</label>
                <textarea
                  rows={3}
                  value={editBio}
